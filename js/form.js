...
// form validation
(function () {
  const AD_FORM_TYPE = window.main.AD_FORM.querySelector(`#type`);
  const AD_FORM_PRICE = window.main.AD_FORM.querySelector(`#price`);
  const AD_FORM_TIME_IN = window.main.AD_FORM.querySelector(`#timein`);
  const AD_FORM_TIME_OUT = window.main.AD_FORM.querySelector(`#timeout`);
  const AD_FORM_ROOMS = window.main.AD_FORM.querySelector(`#room_number`);
  const AD_FORM_GUESTS = window.main.AD_FORM.querySelector(`#capacity`);
